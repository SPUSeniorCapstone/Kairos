...
public class Hero : HeroEntity
{
    ...
    void HandleInput()
    {
        ...
        //Movement
        Vector3 h = Input.GetAxis("Horizontal") * FindObjectOfType<HeroCamera>().GetXZRight();
        Vector3 v = Input.GetAxis("Vertical") * FindObjectOfType<HeroCamera>().GetXZForward();
        Vector3 move = h + v;
